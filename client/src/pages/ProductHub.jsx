      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto space-y-3">
          <span className="inline-flex items-center space-x-2 bg-[#1E232B] border border-[rgba(212,175,106,0.3)] px-3.5 py-1 rounded-full text-xs font-bold text-[#D4AF6A]">
            ...
            <span>FasReach Messaging Products</span>
          </span>
          <h1 className="text-3xl sm:text-4xl font-extrabold text-white tracking-tight">
            Select a Product to <span className="text-[#D4AF6A]">Start Messaging</span>
          </h1>
          <p className="text-xs sm:text-sm text-[#AEB4BC] leading-relaxed">
            Choose between our high-speed Bulk SMS platform, Voice Audio Calls, Branded Sender IDs, or Developer REST APIs.
          </p>
        </div>

        {/* 2 Main Featured Products Grid (Bulk SMS Box & Voice SMS Box Side-by-Side) */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {/* BOX 1: BULK SMS PLATFORM */}
          <div className="bg-[#161B22] border-2 border-[rgba(212,175,106,0.3)] hover:border-[#D4AF6A] rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl transition-all group flex flex-col justify-between relative overflow-hidden">
            ...
            <Link
              to={user ? "/send-sms" : "/register"}
              className="w-full bg-gradient-to-r from-[#D4AF6A] to-[#B88E3E] hover:from-[#E7D3A4] hover:to-[#D4AF6A] text-black font-extrabold text-xs py-3.5 rounded-2xl flex items-center justify-center space-x-2 shadow-lg transition-all active:scale-95"
            >
          ...
          {/* BOX 2: VOICE SMS & AUDIO BROADCASTS */}
          <div className="bg-[#161B22] border-2 border-emerald-500/30 hover:border-emerald-400 rounded-3xl p-6 sm:p-8 space-y-6 shadow-2xl transition-all group flex flex-col justify-between relative overflow-hidden">
            {/* Featured Badge */}
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <h2 className="text-2xl font-black text-white group-hover:text-emerald-400 transition-colors">
                  Voice SMS & Audio Calls
                </h2>
                <p className="text-xs text-[#AEB4BC] leading-relaxed">
                  Deliver automated phone calls with AI Text-to-Speech in Ghanaian English & Twi, live browser mic recordings, or uploaded audio files.
                </p>
              </div>
            ...
            <Link
              to={user ? "/voice-sms" : "/register"}
              className="w-full bg-gradient-to-r from-emerald-400 to-teal-500 hover:from-emerald-300 hover:to-emerald-400 text-black font-extrabold text-xs py-3.5 rounded-2xl flex items-center justify-center space-x-2 shadow-lg transition-all active:scale-95"
            >
              <span>Launch Voice SMS</span>
              <PhoneCall className="w-4 h-4" />
            </Link>
          </div>
        </div>

        {/* Additional Secondary Services Grid (Sender IDs & Developer API) */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
          <div className="bg-[#161B22] border border-white/10 hover:border-[rgba(212,175,106,0.3)] rounded-2xl p-6 flex items-center justify-between space-x-4 transition-all">
            ...
            <Link
              to={user ? "/sender-ids" : "/login"}
              className="bg-[#1E232B] hover:bg-[#2A3038] text-[#D4AF6A] border border-[rgba(212,175,106,0.3)] px-4 py-2 rounded-xl text-xs font-bold shrink-0 transition-colors"
            >
              Manage
            </Link>
          </div>
          ...
          <div className="bg-[#161B22] border border-white/10 hover:border-[rgba(212,175,106,0.3)] rounded-2xl p-6 flex items-center justify-between space-x-4 transition-all">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-[#AEB4BC]">Integrate SMS & Voice API into your website or app.</p>
              </div>
            </div>
            <Link
              to={user ? "/developer-api" : "/login"}
              className="bg-[#1E232B] hover:bg-[#2A3038] text-[#D4AF6A] border border-[rgba(212,175,106,0.3)] px-4 py-2 rounded-xl text-xs font-bold shrink-0 transition-colors"
            >
              API Keys
            </Link>
