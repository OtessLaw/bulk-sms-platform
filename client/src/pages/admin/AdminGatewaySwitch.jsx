  ...
  return (
    <div className="space-y-6 max-w-full overflow-hidden">
      <div>
        ...
        <p className="text-xs text-[#AEB4BC]">Connect your live SMS Gateway and Paystack API keys directly to FasReach</p>
      </div>

      {/* Gateway API Credentials Form */}
      <form onSubmit={handleSave} className="space-y-6">
        {/* 1. Primary SMS Gateway Settings */}
        <div className="bg-[#2A3038]/70 backdrop-blur-md border border-[rgba(212,175,106,0.25)] rounded-3xl p-4 sm:p-6 shadow-2xl space-y-4 max-w-full overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[rgba(212,175,106,0.15)] pb-3 gap-2">
            <h3 className="text-sm font-bold text-white flex items-center gap-2">
              <ShieldCheck className="w-4 h-4 text-[#D4AF6A] shrink-0" /> 1. Primary SMS Gateway API
            </h3>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                placeholder="Paste your Primary SMS Gateway API key here..."
            ...
            <p className="text-[11px] text-[#AEB4BC] mt-1">Get this key from your Telco API Provider dashboard under API Settings.</p>
          </div>
        </div>
        ...
        <div className="bg-[#2A3038]/70 backdrop-blur-md border border-[rgba(212,175,106,0.25)] rounded-3xl p-4 sm:p-6 shadow-2xl space-y-4 max-w-full overflow-hidden">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b border-[rgba(212,175,106,0.15)] pb-3 gap-2">
            <h3 className="text-sm font-bold text-white flex items-center gap-2">
              <Key className="w-4 h-4 text-[#D4AF6A] shrink-0" /> 3. Failover Gateway API (Optional Backup)
            </h3>
