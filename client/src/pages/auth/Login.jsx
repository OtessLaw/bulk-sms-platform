      ...
      <div className="w-full max-w-md bg-[#2A3038]/80 backdrop-blur-xl border border-[rgba(212,175,106,0.25)] rounded-3xl p-8 shadow-2xl space-y-6 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#1E232B] border border-[rgba(212,175,106,0.2)] rounded-xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-[#6B7280] focus:outline-none focus:border-[#D4AF6A] transition-colors"
              />
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-[#D4AF6A] to-[#B88E3E] hover:from-[#E7D3A4] hover:to-[#D4AF6A] text-black font-extrabold text-xs py-3 rounded-xl flex items-center justify-center space-x-2 shadow-xl transition-all disabled:opacity-50"
          >
