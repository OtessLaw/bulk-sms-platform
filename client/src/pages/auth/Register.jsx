        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              <User className="w-4 h-4 text-[#D4AF6A] absolute left-3.5 top-3.5" />
              <input
                type="text"
                required
                value={formData.name}
                ...
                className="w-full bg-[#1E232B] border border-[rgba(212,175,106,0.2)] rounded-xl pl-10 pr-4 py-3 text-base sm:text-xs text-white focus:outline-none focus:border-[#D4AF6A]"
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              <Phone className="w-4 h-4 text-[#D4AF6A] absolute left-3.5 top-3.5" />
              <input
                type="tel"
                required
