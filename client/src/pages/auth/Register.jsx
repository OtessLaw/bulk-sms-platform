          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full bg-[#1E232B] border border-[rgba(212,175,106,0.2)] rounded-xl pl-10 pr-4 py-2.5 text-base sm:text-xs text-white focus:outline-none focus:border-[#D4AF6A]"
              />
            </div>
          </div>
